...
def two_customers_dqn_debug_run():
    ...
    runner_dqn.run_episodes(num_steps, num_episodes, orders_per_day, experiment_name='two_customers_dqn_debug')
...
def two_customers_dqn_debug_sample():
    ...
    runner_dqn = experiment_runner.create_dqn_experiment_runner(num_dcs, num_customers, dcs_per_customer, demand_mean,
                                                                demand_var, num_commodities, orders_per_day, num_steps)
    runner_dqn.run_episodes(num_steps, num_episodes, orders_per_day, experiment_name='two_customers_dqn_debug_sample')
