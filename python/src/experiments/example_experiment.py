...
def small_validation_experiments():
    ...
    runner_randomvalid = experiment_runner.create_randomvalid_experiment_runner(num_dcs, num_customers, dcs_per_customer,
                                                                        demand_mean,
                                                                        demand_var, num_commodities, orders_per_day,
                                                                        num_steps)
    ...
    runner_randomvalid.run_episodes(num_steps, num_episodes, orders_per_day, experiment_name='bestfit_agent_unittest')
