...
def create_summary_reports(experiment_directory):
    summary_movement_reports = shipping_allocation_result_viz.read_all_summary_movement_reports(experiment_directory)
    consolidated_summary = shipping_allocation_result_viz.consolidate_episodes(summary_movement_reports)
    consolidated_summary_path = os.path.join(experiment_directory, "consolidated_summary.csv")
