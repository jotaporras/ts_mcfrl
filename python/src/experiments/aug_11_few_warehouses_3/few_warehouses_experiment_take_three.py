...
def run_bestfit():
    ...
    runner_bestfit.run_episodes(
        num_steps, num_episodes, orders_per_day, experiment_name=f"bestfit_few_warehouses_v3"
    )
    print("===DONE BESTFIT===")
...
def run_random():
    ...
    runner_random.run_episodes(
        num_steps, num_episodes, orders_per_day, experiment_name=f"dumb_few_warehouses_v3"
    )
    print("***DONE RANDOM***")
...
def run_donothing():
    ...
    runner_donothing.run_episodes(
        num_steps, num_episodes, orders_per_day,  experiment_name=f"donotrhing_few_warehouses_v3"
    )
